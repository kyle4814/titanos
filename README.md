...
| Claim | Status |
|---|---|
| Tests pass | ✅ **2,903 tests across 12 subsystems** — green, and verified in a fresh clone, not just on the author's machine |
...
executes 2,871. Both are true, they measure different things, and neither
