...
TEAM_TARGETS: Tuple[TeamTarget, ...] = (
    ...
    TeamTarget(
        ...
        "2026-09-24 12:00 (verified live in register 05 Sep)", "https://www.etenders.gov.ie/epps/cft/prepareViewCfTWS.do?resourceId=8915449",
    ...
    TeamTarget(
        ...
        "2026-09-28 12:00 (verified live in register 05 Sep)",
        "https://www.etenders.gov.ie/epps/cft/prepareViewCfTWS.do?resourceId=8943772",
    ...
    TeamTarget(
        ...
        "2026-09-29 12:00 (verified live in register 05 Sep)",
        "https://www.etenders.gov.ie/epps/cft/prepareViewCfTWS.do?resourceId=8927838",
    ...
    TeamTarget(
        ...
        "2026-10-02 12:00 (verified live in register 05 Sep)",
        "https://www.etenders.gov.ie/epps/cft/prepareViewCfTWS.do?resourceId=8916237",
        "Irish national public-key-infrastructure (managed services) contract.",
    ...
    TeamTarget(
        ...
        "2026-10-12 17:00 (verified live in register 05 Sep)",
        "https://www.etenders.gov.ie/epps/cft/prepareViewCfTWS.do?resourceId=8939732",
        "Irish H&S Authority Security Operations Centre (SOC) tender.",
